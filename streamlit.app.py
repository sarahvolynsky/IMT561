...
def main() -> None:
    ...
    # -------------------------
    st.info(
        "Streamlit re-runs this entire script from top to bottom every time a widget changes. "
        "When you adjust a filter, `selections` updates, `apply_filters()` runs again, "
        "and `df_f` changes — which updates all charts and metrics automatically."
    )
    # -------------------------
    # Header metrics
    # -------------------------
